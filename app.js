...
// ✅ 배포(프록시) 환경 대비: Render/Heroku/Nginx 등 behind proxy일 때 필요
// secure cookie를 true로 쓸 경우 꼭 필요
...
// ✅ 개발환경에서만 sync 권장 (배포에선 마이그레이션 권장)
...
// ✅ 업로드 파일 접근 가능하게(시연용) - 404/에러핸들러보다 "위"에 있어야 함
...
app.use(function (err, req, res, next) {
    ...
    // 뷰 렌더링(기본 express-generator 방식 유지)
